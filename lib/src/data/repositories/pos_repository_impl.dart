...
class PosRepositoryImpl implements PosRepository {
  ...
  Future<List<Product>> getProducts() async {
    try {
      ...
      Logger.debug(' getProducts - storeId: $storeId');

      if (storeId == null) {
        Logger.debug(' getProducts - storeId is null, returning empty list');
        return [];
      }
      ...
      Logger.debug(' getProducts - parsed products length: ${products.length}');
      return products;
    } catch (e) {
      Logger.debug(' getProducts - error: $e');
